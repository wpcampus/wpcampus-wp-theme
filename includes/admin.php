...
function wpcampus_print_meta_boxes( $post, $metabox ) {
	switch( $metabox[ 'id' ] ) {
		...
		case 'wpcampus-podcast-guide':
			?><div style="background:rgba(0,115,170,0.07);padding:18px;color:#000;margin:-6px -12px -12px -12px;">Be sure to read our <a href="https://docs.google.com/document/d/1GG8-qb4OQ3TzDyB1UI00GvRw-agyIO1AT8WUPuyDgHg/edit#heading=h.8dr748uym2qn" target="_blank">Guide For Creating a WPCampus Podcast</a> to help walk you through the process and ensure proper setup.</div><?php
			break;
