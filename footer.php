    ...
    <div id="wpcampus-footer">
        <div class="row">
            <div class="small-12 columns">
                ...
                <a class="wpc-logo"  href="https://wpcampus.org/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/wpcampus-logo-tagline.svg" alt="WPCampus: Where WordPress Meets Higher Education" /></a>
                ...
                <p class="icons">
                    <a class="twitter" href="https://twitter.com/wpcampusorg"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/twitter-black.svg" alt="Follow WPCampus on Twitter" /></a>
                    <a class="youtube" href="https://www.youtube.com/wpcampusorg"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/youtube-black.svg" alt="Follow WPCampus on YouTube" /></a>
                    <a class="github" href="https://github.com/wpcampus/"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/github-black.svg" alt="Follow WPCampus on GitHub" /></a>
                </p>
            </div>
        </div>
    </div> <!-- #wpcampus-footer -->
