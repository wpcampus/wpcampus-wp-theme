(function( $ ) {
	...
	function wpcampus_draw_vote_on_name_chart() {
		...
		$.get( '/wp-json/wpcampus/data/set/vote-on-new-name', function( $wpcampus_data ) {
	...
	function wpcampus_draw_affiliation_chart() {
		...
		// Get the affiliation data
		$.get( '/wp-json/wpcampus/data/set/affiliation', function( $wpcampus_data ) {
	...
	function wpcampus_draw_attend_pref_chart() {
		...
		$.get( '/wp-json/wpcampus/data/set/attend-preference', function( $wpcampus_data ) {
	...
	$(document).on( 'ready', function() {
		...
		$.get( '/wp-json/wpcampus/data/set/sessions', function( $wpcampus_data ) {
	...
	$(document).on( 'ready', function() {
		...
		$.get( '/wp-json/wpcampus/data/set/best-time-of-year', function( $wpcampus_data ) {
	...
	function wpcampus_draw_regions_map() {
		...
		// Get the attend preference data
		$.get( '/wp-json/wpcampus/data/set/attend-country', function( $wpcampus_data ) {
